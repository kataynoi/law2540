        ...
        <div class="panel panel-info ">
            ...
            <div class="alert alert-primary" role="alert">
                <ul style="list-style-type: none">
                    <li>1. ระบบนี้ลงทะเบียนสำหรับประชาชนทั่วไป 12-17 ปี ที่มีภูมิลำเนา
                        หรือพักอาศัยถาวรในจังหวัดมหาสารคาม</li>
                    <li>2. ไม่เคยได้รับวัคซีนป้องกัน Covid-19 มาก่อน</li>
                    <li>3. ไม่ได้ศึกษาอยู่ในระบบการศึกษาใด (นักเรียนที่กำลังเรียนอยู่จัดส่งชื่อโดยกระทรวงศึกษาแล้ว) เช่น
                        ไม่ได้เรียนหนังสือ เรียนตามอัธยาศัย หรือเรียนผ่านการศึกษานอกโรงเรียน เป็นต้น</li>
                    <li>4. ได้รับความเห็นชอบจากผู้ปกรองและเด็กสมัครใจรับวัคซีน</li>
...
<script src="<?php echo base_url() ?>assets/apps/js/whitelist_student.js" charset="utf-8"></script>